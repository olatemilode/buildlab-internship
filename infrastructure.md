...
The application runs as a containerized Node.js/Express service on AWS, built and deployed through an automated CI/CD pipeline. See buildlab.drawio for a visual overview of how these pieces connect.
